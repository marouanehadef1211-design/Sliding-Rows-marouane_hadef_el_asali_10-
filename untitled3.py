# ==============================================================================
"""SlidingRows - variante simple du Puissance 4
Projet L1 : version sans class, sans global, sans try/except.

Bibliothèques utilisées :
- ezTK pour l'interface graphique
- ezCLI pour écrire le fichier des scores
"""
# ==============================================================================
from ezCLI import *
from ezTK import *
